...
plot_ly(proportions, labels = ~race_nofa, values = ~proportion_domViol, type = "pie",
  ...
  layout(title = "Percentage of Each Race Among Those Who Have Experienced Domestic Abuse",
         showlegend = TRUE) 
